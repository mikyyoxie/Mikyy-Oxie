...
def main_share():
    ...
    banner()
    print()
    input_file = open(input("\033[1m\033[38;5;51m Input Cookies Anda , Format ( txt ) : \033[1;37m")).read().split('\n')
    ...
    while True:
        for tach in all:
            ...
            threa.start()
            print(f'\033[1;37m[\033[1;37m{stt}\033[1;37m]\033[1;37m STATUS \033[1;37m|\033[1m\033[38;5;51m BERHASIL \033[1;37m|ID / URL|\033[1;37m\033[1;93m {id_share} \033[1;37m|\n', end='\r')
            time.sleep(delay)
        if stt == total_share:
            break
    gome_token.clear()
    print(f'\033[1;37m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬''')
    print()   
    input('  \033[1;37m[\033[1;31m SUKSES \033[1;37m] \033[1;37m Postingan Berhasil Di Bagikan | Tekan [\033[1m\033[38;5;51m STOP \033[1;37m] Untuk Ulangi \033[0m\033[0m')
while True:
    try:
        main_share()
